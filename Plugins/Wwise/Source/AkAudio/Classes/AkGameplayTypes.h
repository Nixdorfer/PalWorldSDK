...
enum class EAkResult : uint8
{
	...
	IDNotFound = AK_IDNotFound					 UMETA(ToolTip = "The ID was not found."),
	...
	ChildAlreadyHasAParent = AK_ChildAlreadyHasAParent		 UMETA(ToolTip = "The child already has a parent."),
	InvalidLanguage = AK_InvalidLanguage				 UMETA(ToolTip = "The language is invalid (applies to the Low-Level I/O)."),
	CannotAddItseflAsAChild = AK_CannotAddItseflAsAChild		 UMETA(ToolTip = "It is not possible to add itself as its own child."),
