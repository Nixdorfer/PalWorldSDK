...
void UPostEventAtLocationAsync::Activate()
{
	...
	{
		playingIDFuture = DeviceAndWorld.AkAudioDevice->PostEventAtLocationAsync(AkEvent, Location, Orientation, DeviceAndWorld.CurrentWorld, EAkAudioContext::GameplayAudio);
